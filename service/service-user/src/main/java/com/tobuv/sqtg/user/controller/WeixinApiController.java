...
import com.tobuv.sqtg.enums.UserType;
import com.tobuv.sqtg.model.user.User;
import com.tobuv.sqtg.user.service.UserService;
import com.tobuv.sqtg.user.utils.ConstantPropertiesUtil;
import com.tobuv.sqtg.user.utils.HttpClientUtils;
...
public class WeixinApiController {
    ...
    public Result loginWx(@PathVariable String code) {
        ...
        try {
            ...
            throw new CusException(ResultCodeEnum.FETCH_ACCESSTOKEN_FAILD);
        }
